...
export const STICKERS: (Sticker & { earned: (s: S) => boolean })[] = [
  ...
  { id: 'all', emoji: '👑', name: 'PlayPatch Champion', hint: 'Try every game', earned: (s) => Object.keys(s.plays).length >= 32 },
  ...
  { id: 'tables20', emoji: '🎸', name: 'Rising Rocker', hint: 'Get 20 right in one Table Rockstars session', earned: (s) => (s.best.tables ?? 0) >= 20 },
  { id: 'tables40', emoji: '🤘', name: 'Rock Hero', hint: 'Get 40 right in one Table Rockstars session', earned: (s) => (s.best.tables ?? 0) >= 40 },
